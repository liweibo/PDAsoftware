...
import com.crrc.pdasoftware.wuxianzhuanchu.all.adapters.NavbarAdapter;
import com.crrc.pdasoftware.wuxianzhuanchu.all.adapters.ViewAdapter;
...
public class FileView extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.im_backArroLocalFile).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.removefile).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(FileView.this);
                builder.setTitle("提示");
