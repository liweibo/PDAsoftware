...
public class FuwuDataProvider {
     ...
     * @return
     */
    public static List<FuwuDataInfo> getDemoNewInfos() {
        List<FuwuDataInfo> list = new ArrayList<>();

        list.add(new FuwuDataInfo("8888", "2020-02-02 19:33:22","待处理",
                "杭州地铁2号线牵引系统_售后","杭州地铁2号线","2048")
                );
        list.add(new FuwuDataInfo("9999", "2020-04-02 19:13:22","待处理",
                "南京地铁8号线牵引系统_售后","南京地铁8号线","1024")
                );
        list.add(new FuwuDataInfo("2020", "2019-02-02 19:02:22","待处理",
                "四方股份电气牵引系统_售后","HXD1C","6566")
                );
        list.add(new FuwuDataInfo("2288", "2020-02-02 19:34:22","待处理",
                "株机电气牵引系统_售后","HXD1D","2048")
                );
        list.add(new FuwuDataInfo("8778", "2020-01-01 19:39:22","待处理",
                "长沙地铁2号线牵引系统_售后","长沙地铁2号线","4096")
                );
        list.add(new FuwuDataInfo("0028", "2018-02-02 19:33:22","待处理",
                "长沙地铁5号线牵引系统_售后","长沙地铁5号线","8700")
                );
