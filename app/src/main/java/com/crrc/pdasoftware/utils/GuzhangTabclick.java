...
public class GuzhangTabclick {
    ...
    public void clickFuwuxiangy() {
        tvFuwuxiangy.setBackgroundResource(R.drawable.textview_border_special_btn);
        tvFuwuxiangy.setTextColor(Color.parseColor("#FFFFFF"));
    ...
    public void clickDaodaxianc() {
        tvDaodaxianc.setBackgroundResource(R.drawable.textview_border_special_btn);
        tvDaodaxianc.setTextColor(Color.parseColor("#FFFFFF"));
    ...
    public void clickGuzhangchuli() {
        tvGuzhangcl.setBackgroundResource(R.drawable.textview_border_special_btn);
        tvGuzhangcl.setTextColor(Color.parseColor("#FFFFFF"));
