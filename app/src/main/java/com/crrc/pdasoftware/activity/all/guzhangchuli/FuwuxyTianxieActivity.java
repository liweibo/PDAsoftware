...
public class FuwuxyTianxieActivity extends AppCompatActivity implements FuwuFragment.OnListFragmentInteractionListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemPos = intent.getIntExtra("whichPosition", 0);
        System.out.println("=======000:"+itemPos);
...
//                List<Map> listRE = new NetUtils(FuwuxyTianxieActivity.this).request();
//                System.out.println("展示数据：" + listRE.toString());
